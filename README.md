...
Therefore, we created two pipelines, the pipeline where he trained the aforementioned Voting Classifier with all the train_set and the pipeline_test which he gave to the categorizer to predict the total trajectories of the test_set.
